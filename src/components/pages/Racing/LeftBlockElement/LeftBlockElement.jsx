...
const LeftBlockElement = ({textLabel = 'total invested', upBlockText = 'royalties', upBlockNumber = '000,000,000', icon = image, downBlockNumber = '000,000,000.00'}) => {
    return (
        <div className = {styles.leftBlockElement}>
