...
const StatisticElementText = ({
  ...
  return (
    <div className={classes.statisticElementText}>
      {hiddenText ? (
        <span
          className={cn(classes.statisticElementTextSp, {
      ...
      <p>{payout}</p>
      {!hiddenImg && (
        <img style={{ ...elementImgStyle }} className={classes.statisticElementTextImg} src={elementImg} alt="" />
      )}
    </div>
  );
};
